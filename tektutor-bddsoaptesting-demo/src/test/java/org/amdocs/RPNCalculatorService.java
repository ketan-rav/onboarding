 ...
 * 
 */
@WebServiceClient(name = "RPNCalculatorService", targetNamespace = "http://amdocs.org", wsdlLocation = "http://localhost:8080/rpncalculator-ws/services/RPNCalculator?WSDL")
    ...
    extends Service
{
    ...
    private final static QName RPNCALCULATORSERVICE_QNAME = new QName("http://amdocs.org", "RPNCalculatorService");
    ...
    public RPNCalculator getRPNCalculator() {
        return super.getPort(new QName("http://amdocs.org", "RPNCalculator"), RPNCalculator.class);
    }
    ...
    public RPNCalculator getRPNCalculator(WebServiceFeature... features) {
        return super.getPort(new QName("http://amdocs.org", "RPNCalculator"), RPNCalculator.class, features);
    }
